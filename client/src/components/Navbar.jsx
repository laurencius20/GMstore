...
const ShoppingCartIcon = () => {
  ...
  return (
    <Flex>
      <Text fontStyle='italic' as='sub' fontSize='xs' fontWeight='extrabold'>
        {cart.length}
      </Text>
        ...
        <HStack>
          <Link as={ReactLink} to='/'>
            <Flex alignItems='center'>
              <Icon as={AiFillShop} h={6} w={6} color='blue.600' />
              <Text fontWeight='extrabold' pl='2'>
                Grahanindo Store
              </Text>
            </Flex>
          </Link>
            ...
            <>
              <Menu>
                ...
                <MenuList>
                  ...
                  <MenuItem hidden={userInfo.isAdmin === 'true'} as={ReactLink} to='/your-orders'>
                    <MdLocalShipping />
