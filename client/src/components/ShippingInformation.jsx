            ...
            >
              <Stack direction={{ base: 'column', lg: 'row' }} align={{ lg: 'flex-start' }}>
                <Stack pr='10' spacing={{ base: '8', md: '10' }} flex='1.5'>
                  <Box>
                    <Radio value='true'>
                      <Text fontWeight='bold'>Express Rp. 200.000</Text>
                ...
                <Radio value='false'>
                  <Tooltip label='Free shipping for orders of Rp. 5.000.000 or more!'>
                    <Box>
                      <Text fontWeight='bold'>Standard Rp. 100.000</Text>
