            ...
            <Stack direction={{ base: 'column', lg: 'row' }} align={{ lg: 'flex-start' }}>
              ...
              >
                ...
                <Stack spacing='5'>
                  <Box>
                    <Text fontSize='xl'>
                      Rp. {Number(product.price).toLocaleString('id-ID', { maximumFractionDigits: 3 })}
                    </Text>
                    <Flex>
                      <HStack spacing='2px'>
                  ...
                  <Stack width='360px'>
                    <Flex alignItems='center'>
                      ...
                      <Text fontWeight='medium' fontSize='sm' ml='2'>
                        Free shipping if order is above Rp. 5.000.000
                      </Text>
                    </Flex>
                    <Flex alignItems='center'>
              ...
              <Flex direction='column' align='center' flex='1'>
                <Image rounded='lg' mb='30px' src={product.image} alt={product.name} />
              </Flex>
            </Stack>
            {userInfo && (
              <>
