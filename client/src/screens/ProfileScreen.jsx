...
const ProfileScreen = () => {
  ...
  return userInfo ? (
    <Formik
      ...
      onSubmit={(value) => {
        dispatch(updateProfile(userInfo._id, value.name, value.email, value.password));
      }}
    >
      {(formik) => (
        <Box
        ...
        >
          <Stack spacing='10' direction={{ base: 'column', lg: 'row' }} align={{ lg: 'flex-start' }}>
            ...
            <Flex direction='column' align='center' flex='1' _dark={{ bg: 'gray.900', rounded: 'lg' }}>
              <Card>
                <CardHeader size='md'>User Report</CardHeader>
                <CardBody>
